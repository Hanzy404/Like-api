...
liked_tracker = CacheManager() 
rate_limiter = defaultdict(lambda: {'count': 0, 'reset_time': time.time()})

# ==================== VALIDATION & ENCRYPTION ====================
VALID_SERVERS = [ "IDN", "IND", "BR", "US", "SAC", "NA", "BD", "RU"]
...
def load_accounts(server_name):
    ...
    filename = server_map.get(server_name, "account_bd.txt")
    
    # Try multiple fallback files
    fallback_files = [filename, "account_ind.txt", "account_bd.txt"]
    accounts = []
...
def get_player_info(encrypted_uid, server_name, token):
    ...
    server_urls = {
        ...
        "IDN": "https://client.id.freefiremobile.com/GetPlayerPersonalShow"
    }
...
def handle_like_request():
    ...
    try:
        ...
        like_urls = {
            ...
            "IDN": "https://client.id.freefiremobile.com/LikeProfile"
        }
